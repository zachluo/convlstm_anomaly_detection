...
_SOLVERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='zstormStepType', full_name='caffe.SolverParameter.zstormStepType', index=40,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='zstormParam', full_name='caffe.SolverParameter.zstormParam', index=41,
...
_ZSTORMSTEPPARAMETER = _descriptor.Descriptor(
  name='ZstormStepParameter',
  full_name='caffe.ZstormStepParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='first_layer_name', full_name='caffe.ZstormStepParameter.first_layer_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='first_blob_name', full_name='caffe.ZstormStepParameter.first_blob_name', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='final_blob_name', full_name='caffe.ZstormStepParameter.final_blob_name', index=2,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='unpooling_param', full_name='caffe.LayerParameter.unpooling_param', index=42,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='video_data_param', full_name='caffe.LayerParameter.video_data_param', index=59,
...
_LOSSPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='axis', full_name='caffe.LossParameter.axis', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='zstorm_loss', full_name='caffe.LossParameter.zstorm_loss', index=4,
      number=5, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VIDEODATAPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_color', full_name='caffe.VideoDataParameter.is_color', index=6,
      number=11, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='scale', full_name='caffe.VideoDataParameter.scale', index=7,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mean_file', full_name='caffe.VideoDataParameter.mean_file', index=8,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='crop_size', full_name='caffe.VideoDataParameter.crop_size', index=9,
      number=5, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mirror', full_name='caffe.VideoDataParameter.mirror', index=10,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='root_folder', full_name='caffe.VideoDataParameter.root_folder', index=11,
      number=12, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='t', full_name='caffe.VideoDataParameter.t', index=12,
      number=13, type=13, cpp_type=3, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='stride', full_name='caffe.VideoDataParameter.stride', index=13,
...
_RECURRENTPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='wxc_convolution_param', full_name='caffe.RecurrentParameter.wxc_convolution_param', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='whh_convolution_param', full_name='caffe.RecurrentParameter.whh_convolution_param', index=6,
      number=7, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SOLVERPARAMETER.fields_by_name['zstormParam'].message_type = _ZSTORMSTEPPARAMETER
...
_RECURRENTPARAMETER.fields_by_name['wxc_convolution_param'].message_type = _CONVOLUTIONPARAMETER
_RECURRENTPARAMETER.fields_by_name['whh_convolution_param'].message_type = _CONVOLUTIONPARAMETER
...
DESCRIPTOR.message_types_by_name['ZstormStepParameter'] = _ZSTORMSTEPPARAMETER
...
ZstormStepParameter = _reflection.GeneratedProtocolMessageType('ZstormStepParameter', (_message.Message,), dict(
  DESCRIPTOR = _ZSTORMSTEPPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.ZstormStepParameter)
  ))
_sym_db.RegisterMessage(ZstormStepParameter)
